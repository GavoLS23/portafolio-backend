...
/** Punto de entrada de la aplicación.
  ...
  *   1. Cargar configuración desde variables de entorno (Ciris)
  *   2. Crear pool de conexiones HikariCP
  *   3. Ejecutar migraciones Flyway (crea schema si no existe)
  *   4. Inicializar cliente AWS S3
  *   5. Crear seed del admin si la BD está vacía
  *   6. Levantar el servidor HTTP (Ember)
  */
